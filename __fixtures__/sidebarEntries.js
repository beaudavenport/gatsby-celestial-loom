  ...
  events: {
    ...
    edges: [{
      node: {
        ...
        frontmatter: {
          title: 'Moon Circle', image: '/assets/gemini-moon-circle.jpg', eventDate: 'May 30, 2019', eventTime: '7 PM - 9 PM', eventDateShort: 'May 30', eventPrice: 25, priceDescription: '2 Hour Playshop', location: 'Divine Inspirations',
        },
      ...
      node: {
        ...
        frontmatter: {
          title: 'STONES OF FIRE', image: '/assets/stones-of-fire-lotus.jpg', eventDate: 'Jun 08, 2019', eventTime: '1PM - 4 PM', eventDateShort: 'Jun 08', eventPrice: 35, priceDescription: '3 Hour Playshop', location: 'DeMun Healing',
        },
