  ...
  blog: {
    ...
    edges: [{
      node: {
        ...
        frontmatter: {
          title: 'NORWAC - I AM ON MY WAY', image: '/assets/cancer-norwac.jpg', publishDate: 'May 23, 2019', relatedItems: ['Cancer', 'Gemini', 'Aquarius'],
        },
      ...
      node: {
        ...
        frontmatter: {
          title: 'The Pleiades', image: '/assets/pleiades.jpg', publishDate: 'May 21, 2019', relatedItems: ['Taurus', 'Gemini'],
        },
  ...
  events: {
    ...
    edges: [{
      node: {
        ...
        frontmatter: {
          title: 'Moon Circle', image: '/assets/gemini-moon-circle.jpg', eventDate: 'Thursday, May 30', eventTime: '7 PM - 9 PM', eventDateShort: 'May 30', eventPrice: 25, priceDescription: '2 Hour Playshop', location: 'Divine Inspirations',
        },
      ...
      node: {
        ...
        frontmatter: {
          title: 'STONES OF FIRE', image: '/assets/stones-of-fire-lotus.jpg', eventDate: 'Saturday, Jun 08', eventTime: '1PM - 4 PM', eventDateShort: 'Jun 08', eventPrice: 35, priceDescription: '3 Hour Playshop', location: 'DeMun Healing',
        },
